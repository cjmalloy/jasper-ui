...
| `maxEmbedNesting` | `JASPER_MAX_EMBED_NESTING` | Maximum embed depth within rendered Markdown (positive integer, first embed is depth 1). At the limit, further ref/query embeds become links; media and expansion toggles are omitted to prevent recursion. | `3` |
