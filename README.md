...
| `maxEmbedNesting` | `JASPER_MAX_EMBED_NESTING` | Maximum automatic embed depth (positive integer, first embed is depth 1). Further ref, query, and media embeds show a clickable placeholder. Each click embeds one more level while deeper embeds remain placeholders; links and expansion toggles stay available. | `3` |
