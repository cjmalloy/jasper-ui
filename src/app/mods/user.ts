...
export const userCursorPlugin: Plugin = {
  tag: 'plugin/user/cursor',
  name: $localize`Notification Cursor`,
  config: {
    mod: $localize`🧑️ User`,
    version: 1,
    default: true,
    generated: $localize`Generated by jasper-ui ${DateTime.now().toISO()}`,
    description: $localize`Stores a notification cursor on a user settings Ref.`,
    internal: true,
  },
  schema: {
    properties: {
