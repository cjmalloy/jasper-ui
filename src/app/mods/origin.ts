...
export const originPullPlugin: Plugin = {
  ...
  config: {
    ...
    actions: [
      { response: '+plugin/run', labelOn: $localize`cancel`, labelOff: $localize`pull`, title: $localize`Pull a batch of updates from the remote.`, confirm: $localize`Are you sure you want to pull?` },
...
export const originPushPlugin: Plugin = {
  ...
  config: {
    ...
    actions: [
      { response: '+plugin/run', labelOn: $localize`cancel`, labelOff: $localize`push`, title: $localize`Push a batch of updates to the remote.`, confirm: $localize`Are you sure you want to push?` },
      { tag: '+plugin/cron', labelOn: $localize`disable`, labelOff: $localize`enable` },
    ],
    // language=Handlebars
    infoUi: `
