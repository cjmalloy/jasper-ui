...
export const ytdlpDepsPlugin: Plugin = {
  tag: '_plugin/delta/ytdlp/deps',
  name: $localize`▶️ YT-DLP Dependencies`,
  config: {
    mod: $localize`▶️ YT-DLP`,
    default: false,
    generated: $localize`Generated by jasper-ui ${DateTime.now().toISO()}`,
    ...
    language: 'shell',
    // language=bash
    script: `{ command -v ffmpeg || apt-get update && apt-get install ffmpeg -y; } > /dev/null`,
  },
};
