...
![](/tag/+plugin/ai/dalle?view=plugin%2Fimage&filter=query%2Fplugin%2Fimage&cols=4) If you include a regular link to it, a toggle to show / hide
the embed will be added: [Click on this text](/tag/+plugin/ai/dalle).
Referencing queries using the [Regular text with embed toggle](/tag/+plugin/ai/dalle?view=plugin%2Fimage&filter=query%2Fplugin%2Fimage) notation is preferred.
