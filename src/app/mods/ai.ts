...
export const dalleQueryPlugin: Plugin = {
  ...
  config: {
    ...
    submitDm: $localize`👨️‍🎨️ chat`,
    filters: [
      { query: 'plugin/inbox/dalle', label: $localize`👨️‍🎨️💭️ ai query`, group: $localize`Notifications ✉️` },
    ],
    advancedActions: [
...
export const dallePlugin: Plugin = {
  ...
  config: {
    ...
    icons: [{ label: $localize`👨️‍🎨️`}],
    filters: [
      { query: '+plugin/dalle', label: $localize`👨️‍🎨️ ai`, group: $localize`Plugins 🧰️` },
    ],
