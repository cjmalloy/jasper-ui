...
export const backgammonRngDicePlugin: Plugin = {
  tag: 'plugin/backgammon/rng.dice',
  name: $localize`🎲️ Backgammon Fair Dice`,
  config: {
    mod: $localize`🎲️ Backgammon`,
    version: 1,
    type: 'plugin',
    ...
    description: $localize`Activates built-in Backgammon plugin/rng support for remote games`,
  },
};
