...
export const bbPlugin: Plugin = {
  tag: 'plugin/bb',
  name: $localize`BBCode`,
  config: {
    version: 1,
    type: 'editor',
    generated: $localize`Generated by jasper-ui ${DateTime.now().toISO()}`,
    description: $localize`Use BBCode instead of Markdown. Supports [b], [i], [u], [s], [quote], [code], [url], [email], [img], and [list] with [*] items.`,
    editorButtons: [{ label: $localize`BBCode`, remember: true, ribbon: true, global: true }],
  },
};

export const bbMod: Mod = {
  plugin: [bbPlugin],
};
