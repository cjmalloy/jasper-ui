...
export const aiQueryPlugin: Plugin = {
  ...
  config: {
    ...
    script: `
      ...
      config.url ||= hasTag('plugin/llm/url', ref);
...
export const llmUrlPlugin: Plugin = {
  tag: 'plugin/llm/url',
  name: $localize`🔭️ AI URL Context`,
  config: {
    mod: $localize`✨️ AI Generation`,
    type: 'tool',
    default: false,
    ...
    generated: $localize`Generated by jasper-ui ${DateTime.now().toISO()}`,
    icons: [
      { label: $localize`🌐️`, title: $localize`AI URL Context` },
    ],
    editorButtons: [{ tag: 'plugin/llm', label: $localize`🔭️ URL`, ribbon: true }],
  }
};

export const llmSearchPlugin: Plugin = {
  tag: 'plugin/llm/search',
  name: $localize`🔎️ AI Search`,
  config: {
    mod: $localize`✨️ AI Generation`,
    type: 'tool',
    default: false,
    ...
    generated: $localize`Generated by jasper-ui ${DateTime.now().toISO()}`,
    icons: [
      { label: $localize`🔎️`, title: $localize`AI Web Search` },
    ],
