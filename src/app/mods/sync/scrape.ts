...
export const asyncScrapeTargetPlugins: Plugin[] = [
  { tag: '_plugin/delta/scrape/ref', name: $localize`🪝 Scrape Ref` },
  { tag: '_plugin/delta/scrape/title', name: $localize`🪝 Scrape Title` },
  { tag: '_plugin/delta/scrape/comment', name: $localize`🪝 Scrape Comment` },
  { tag: '_plugin/delta/scrape/sources', name: $localize`🪝 Scrape Sources` },
  { tag: '_plugin/delta/scrape/alts', name: $localize`🪝 Scrape Alternate URLs` },
  { tag: '_plugin/delta/scrape/plugins', name: $localize`🪝 Scrape Plugins` },
  { tag: '_plugin/delta/scrape/tags', name: $localize`🪝 Scrape Tags` },
  { tag: '_plugin/delta/scrape/published', name: $localize`🪝 Scrape Published Date` },
].map(plugin => ({
  ...plugin,
  config: {
    mod: $localize`🪝 Scrape`,
