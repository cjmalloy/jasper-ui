...
export const asyncScrapeTargetPlugins: Plugin[] = [
  {
    tag: '_plugin/delta/scrape/ref',
    name: $localize`🪝 Scrape Ref`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/title',
    name: $localize`🪝 Scrape Title`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/comment',
    name: $localize`🪝 Scrape Comment`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/sources',
    name: $localize`🪝 Scrape Sources`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/alts',
    name: $localize`🪝 Scrape Alternate URLs`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/plugins',
    name: $localize`🪝 Scrape Plugins`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/tags',
    name: $localize`🪝 Scrape Tags`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
  ...
  {
    tag: '_plugin/delta/scrape/published',
    name: $localize`🪝 Scrape Published Date`,
    config: {
      mod: $localize`🪝 Scrape`,
      version: 1,
      default: true,
