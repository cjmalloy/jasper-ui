...
export const summaryQueryPlugin: Plugin = {
  ...
  config: {
    ...
    filters: [
      { query: 'plugin/delta/summary', label: $localize`✂️️💭️ summarized`, group: $localize`Notifications ✉️` },
    ],
    advancedActions: [
...
export const summaryPlugin: Plugin = {
  ...
  config: {
    ...
    filters: [
      { query: '+plugin/delta/summary', label: $localize`✂️️ summary`, group: $localize`Delta Δ` },
    ],
    // language=Handlebars
