...
export class TodoComponent implements OnChanges {
    ...
    this.comment$(comment).pipe(
      catchError(err => {
        if (err?.conflict) {
          ...
          const { mergedComment, stillHasConflict } = this.tryAutoResolveTodoConflict(err.conflict);
   ...
   */
  private tryAutoResolveTodoConflict(conflict: MergeRegion<string>[]): { mergedComment?: string, stillHasConflict?: boolean } {
