...
const routes: Routes = [
  ...
  { path: 'home', component: HomePage, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
  ...
  { path: 'user/:tag', component: UserPage, canDeactivate: [pendingChangesGuard], runGuardsAndResolvers: 'always' },
  {
    ...
    children: [
      ...
      { path: 'thread', component: RefThreadComponent, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
      { path: 'responses', component: RefResponsesComponent, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
      { path: 'errors', component: RefErrorsComponent, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
      { path: 'sources', component: RefSourcesComponent, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
      { path: 'alts', component: RefAltsComponent, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
      { path: 'versions', component: RefVersionsComponent, canDeactivate: [pendingChangesGuard, clearLastSelected], runGuardsAndResolvers: 'always' },
    ],
  }, {
    path: 'inbox',
    component: InboxPage,
