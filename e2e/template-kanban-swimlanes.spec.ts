...
test.describe.serial('Kanban Template with Swim Lanes', () => {
  ...
  test('creates a board with swim lanes', async () => {
    ...
    await page.locator('[name=tag]').fill('kanban/sl');
    ...
    await page.locator('.swim-lanes button').click();
  ...
  test('add to board', async () => {
    ...
    await page.locator('.kanban-column:nth-of-type(7) a', { hasText: 'first step' }).click();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'Kanban Swim Lane Test' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('alice');
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('bob');
  ...
  test('move to doing', async () => {
    ...
    await page.locator('.kanban-column:nth-of-type(8) a', { hasText: 'first step' }).click();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'Kanban Swim Lane Test' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('alice');
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('bob');
  ...
  test('move to done', async () => {
    ...
    await page.locator('.kanban-column:nth-of-type(9) a', { hasText: 'first step' }).click();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'Kanban Swim Lane Test' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('alice');
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('bob');
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('doing');
  ...
  test('assign to bob', async () => {
    ...
    await page.locator('.kanban-column:nth-of-type(4) a', { hasText: 'first step' }).click();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'Kanban Swim Lane Test' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('alice');
  ...
  test('move to bob doing', async () => {
    ...
    await page.locator('.kanban-column:nth-of-type(5) a', { hasText: 'first step' }).click();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'Kanban Swim Lane Test' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('alice');
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'bob' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'doing' })).toBeVisible();
  ...
  test('move to bob done', async () => {
    ...
    await page.locator('.kanban-column:nth-of-type(6) a', { hasText: 'first step' }).click();
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'Kanban Swim Lane Test' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('alice');
    await expect(page.locator('.full-page.ref .tag:not(.user)', { hasText: 'bob' })).toBeVisible();
    await expect(page.locator('.full-page.ref .tag:not(.user)')).not.toContainText('doing');
